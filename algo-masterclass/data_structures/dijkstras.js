...
class WeightedGraph {
  ...
  Dijkstra(start, finish) {
    ...
    // build up initial state ~ loop over entire adjacency list
...
//   the priority queue, except the starting vertex, which should have a priority of 0 because that's where we begin.
...
//
// * should return an array with the nodes in order (shortest path)
